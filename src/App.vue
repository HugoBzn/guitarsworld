        ...
        <div class="row mt-5">
          <div class="col-md-6 text-center text-md-start pt-5">
            ...
            <p class="mt-5 fs-5 text-white">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus, possimus quibusdam dolor nemo velit
              quo, fuga omnis, iure molestias optio tempore sint at ipsa dolorum odio exercitationem eos inventore odit.
            </p>
      ...
      <div class="row mt-5">
        <div class="col-md-6 col-lg-4 my-4 row align-items-center">
          ...
          <div class="col-8">
            ...
            <p>
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sit quae labore odit magnam in autem nesciunt,
              amet deserunt
            </p>
